...
export const ActionsPage: React.FC<ActionsPageProps> = ({ onNavigate }) => {
  const [activeTab, setActiveTab] = useState<'nettoyage' | 'embellissement' | 'equipements' | 'social' | 'ramadan'>('nettoyage');
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12" id="actions-page">
      ...
      <div className="flex flex-wrap gap-2 p-1.5 bg-[#F0EFEA] rounded-2xl border border-[#0D3823]/10">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-bold uppercase tracking-wider transition-all ${
            activeTab === 'nettoyage'
      ...
      {activeTab === 'nettoyage' && (
        <div className="space-y-8 animate-fade-in">
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-[#0D3823]/10 shadow-sm space-y-6">
            <div className="flex items-center gap-3">
              <span className="text-3xl">🧹</span>
              <div>
                <span className="text-xs uppercase tracking-widest font-extrabold text-[#0D3823]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pt-4">
              <div className="bg-[#FAF9F5] p-5 rounded-2xl border border-gray-200 space-y-2">
                <div className="w-9 h-9 rounded-xl bg-[#0D3823] text-[#D4AF37] flex items-center justify-center font-bold text-sm">
                  1
                </div>
                <h4 className="font-bold text-base text-[#0D3823]">Lavage à Grande Eau</h4>
              ...
              <div className="bg-[#FAF9F5] p-5 rounded-2xl border border-gray-200 space-y-2">
                ...
                <h4 className="font-bold text-base text-[#0D3823]">Balayage Systématique</h4>
                <p className="text-xs text-gray-600 leading-relaxed">
              ...
              <div className="bg-[#FAF9F5] p-5 rounded-2xl border border-gray-200 space-y-2">
                ...
                <h4 className="font-bold text-base text-[#0D3823]">Dépoussiérage Profond</h4>
                <p className="text-xs text-gray-600 leading-relaxed">
              ...
              <div className="bg-[#FAF9F5] p-5 rounded-2xl border border-gray-200 space-y-2">
                ...
                <h4 className="font-bold text-base text-[#0D3823]">Désinfection Ablutions</h4>
                <p className="text-xs text-gray-600 leading-relaxed">
          ...
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-[#0D3823]/10 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
              <div className="bg-[#FAF9F5] p-6 rounded-2xl border border-gray-200 space-y-3">
                <div className="w-10 h-10 rounded-xl bg-emerald-100 text-[#0D3823] flex items-center justify-center">
                  <TreePine className="w-5 h-5" />
                </div>
                <h4 className="font-bold text-base text-[#0D3823]">Plantation d'Arbres d'Ombrage</h4>
              ...
              <div className="bg-[#FAF9F5] p-6 rounded-2xl border border-gray-200 space-y-3">
                ...
                <h4 className="font-bold text-base text-[#0D3823]">Gestion Raisonnée de l'Eau</h4>
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
              ...
              <div className="bg-[#FAF9F5] p-6 rounded-2xl border border-gray-200 space-y-3">
                ...
                <h4 className="font-bold text-base text-[#0D3823]">Valorisation des Espaces</h4>
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
        ...
        <div className="space-y-8 animate-fade-in">
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-[#0D3823]/10 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-4">
              <div className="bg-[#FAF9F5] p-5 rounded-2xl border border-gray-200 space-y-2">
                <h4 className="font-bold text-base text-[#0D3823] flex items-center gap-2">
        ...
        <div className="space-y-8 animate-fade-in">
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-[#0D3823]/10 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              <div className="bg-[#FAF9F5] p-6 rounded-2xl border border-gray-200 space-y-3">
                <h4 className="font-bold text-base text-[#0D3823]">Soutien aux Écoles Coraniques (Daaras)</h4>
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
              ...
              <div className="bg-[#FAF9F5] p-6 rounded-2xl border border-gray-200 space-y-3">
                <h4 className="font-bold text-base text-[#0D3823]">Accompagnement des Personnes Âgées</h4>
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
      ...
      {activeTab === 'ramadan' && (
        <div className="space-y-8 animate-fade-in">
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-[#0D3823]/10 shadow-sm space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200 text-xs sm:text-sm text-amber-900 font-medium leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
              <div className="bg-[#FAF9F5] p-5 rounded-2xl border border-gray-200 space-y-2">
                <h4 className="font-bold text-base text-[#0D3823]">Kits Alimentaires Complets</h4>
                <p className="text-xs text-gray-600 leading-relaxed">
              ...
              <div className="bg-[#FAF9F5] p-5 rounded-2xl border border-gray-200 space-y-2">
                <h4 className="font-bold text-base text-[#0D3823]">Sur le Parvis & Carrefours</h4>
                <p className="text-xs text-gray-600 leading-relaxed">
              ...
              <div className="bg-[#FAF9F5] p-5 rounded-2xl border border-gray-200 space-y-2">
                <h4 className="font-bold text-base text-[#0D3823]">Mobilisation Régionale Décentralisée</h4>
                <p className="text-xs text-gray-600 leading-relaxed">
            ...
            <div className="pt-4 flex justify-end">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0D3823] hover:bg-[#145334] text-white text-xs font-bold uppercase tracking-wider transition-colors shadow-sm"
              >
      ...
      <div className="p-8 rounded-3xl bg-[#0D3823] text-white flex flex-col md:flex-row items-center justify-between gap-6 border border-[#D4AF37]/30">
        ...
        <button
          ...
          className="px-6 py-3 rounded-xl bg-[#D4AF37] hover:bg-[#c49f2b] text-[#0A291A] font-extrabold text-xs uppercase tracking-wider transition-all shrink-0 active:scale-95"
        >
